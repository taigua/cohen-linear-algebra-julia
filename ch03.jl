...
# ╔═╡ 389fb2ef-3861-4a3a-879f-64b2a0a2961e
using CairoMakie, LinearAlgebra

# ╔═╡ 22a8f550-9bb8-11ee-2c1c-d766ecead185
md"""
# Chapter 3 Vector Multiplications
"""

# ╔═╡ 62c24ebb-3ff5-431e-8f15-1bc87c0c88ce
md"""
## 3.1 Vector dot product: Algebra
"""

# ╔═╡ e9e0798c-31d6-44ad-907e-fecdb3a29379
# Code block 3.1/3.2
let
    v1 = [2, 5, 4, 7]
    v2 = [4, 1, 0, 2]
...
# ╔═╡ ca194a51-e7ad-42de-8937-c81faa8b31bc
md"""
## 3.2 Dot product properties
"""

# ╔═╡ 45fb1e89-ccbe-4fa9-87a1-22619f707f1a
md"""
## 3.3 Vector dot product: Geometry
"""

# ╔═╡ bcc1ea02-2791-403e-abde-8b3b9c94fbde
md"""
## 3.4 Algebra and geometry
"""

# ╔═╡ c53c7285-4b19-4161-89cc-b9d606e6d1c0
md"""
## 3.5 Linear weighted combination
"""

# ╔═╡ 89a4ffb0-1f2b-41a2-9fa2-3cd01af650b4
# Code block 3.3/3.4
let
    l1 = 1
    l2 = 2
...
# ╔═╡ 8bc32506-4279-4a9d-ab94-bcb6e81c1e4d
md"""
## 3.6 The outer product
"""

# ╔═╡ 11035279-cc34-4044-a0b2-ef32545c1e0a
# Code block 3.5/3.6
let
    v1 = [2, 5, 4, 7]
    v2 = [4, 1, 0, 2]
...
# ╔═╡ 7bfe5724-ec60-44ab-9d76-de0c44edae5c
md"""
## 3.7 Element-wise (Hadamard) vector product
"""

# ╔═╡ 101103c4-3507-4d44-aa15-6e5e0398a44f
# Code block 3.7/3.8
let
    v1 = [2, 5, 4, 7]
    v2 = [4, 1, 0, 2]
...
# ╔═╡ a88c8164-4387-4bae-b1f9-0a2eb09d4c8c
md"""
## 3.8 Cross product
"""

# ╔═╡ 17ab384f-4ff5-45c8-9663-7e62e52fe9f5
md"""
## 3.9 Unit vector
"""

# ╔═╡ ee7e6bfa-196c-431a-b782-9925404fa8e8
# Code block 3.9/3.10
let
    v = [2, 5, 4, 7]
	vmag = norm(v)
...
# ╔═╡ 3070e516-381b-445e-b0d1-cab8a3004462
md"""
## 3.10 Exercises
"""

# ╔═╡ f542f46a-b919-4479-ab47-8d215337f511
# E.1
begin
    # [0, a] ⋅ [b, 0] == 0
    # [a, b] ⋅ [c, d] == ac + bd
    ...
    [10, 14, -3] ⋅ [-1, 1, -6] == 22
    # [1, a] ⋅ [b, 1] == b + a
    # [2i, 4 - i, 3] ⋅ [3, 3, 1] == 15 + 3i
    [1, 2] ⋅ [2, -1] == 0
    [1, -2, -3, 4, 5, -6] ⋅ [-4, 3, 4, -5, 6, -2] == 0
    [2, -5, 0, 0, 2, -8] ⋅ [-1, 5, 0, -1, 0, -4] == 5
    [2.47, -2.47] ⋅ [π^3, π^3] == 0
    [2, 3, -3, 2] ⋅ [0, 12, -8, 4] == 68
    [2, -1, -2] ⋅ [-2, 1, -5//2] == 0
    # [0, 0] ⋅ [a, b] == 0
...
# ╔═╡ 8fd77bc6-0ddd-4cb1-bca9-e60734cfe3ed
md"""
**E.2**
- a) True
- b) True
...
# ╔═╡ 766cd601-f0d3-431e-b909-c338dfeb7190
# E.3
let
    # a)
    a = [1, 2, 3]
...
# ╔═╡ 6813b418-78b6-44d9-8469-6ff17567646e
# E.4
begin
    [1, 2] * [1 2] == [1 2; 2 4]
    [-1, 3, 0] * [0 1 3] == [0 -1 -3; 0 3 9; 0 0 0]
    ...
    [1, 2, 3, 4] * [10 20 30 40] == [10 20 30 40
                                     ...
                                     30 60 90 120
                                     40 80 120 160]
    # [1, 1, 2, 2] * [a b c d]' == [a b c d; a b c d; 2a 2b 2c 2d; 2a 2b 2c 2d]
    [4, 2, 3, 1] * [6 7 5] == [24 28 20; 12 14 10; 18 21 15; 6 7 5]
    [3, 40] * [10 2 30 4] == [30 6 90 12; 400 80 1200 160]
    # [a, b, c, d] * [1 1 2 2] == [a a 2a 2a; b b 2b 2b; c c 2c 2c; d d 2d 2d]
end

# ╔═╡ 2724d233-c25a-4936-815d-a0dc72a58601
md"""
**E.5**
- a) Yes
- b) No
...
# ╔═╡ 5d03b1a0-4297-45f8-99af-4c5a0f375c53
md"""
**E.6**
- a) 0
- b) $|v|^2$
...
# ╔═╡ 50eeed02-e286-4156-b182-3f5ab83038e5
md"""
## 3.12 Code challenges
"""

# ╔═╡ 2fc7f2c6-41c4-4363-8027-df7f106b73d7
# Code block 3.11/3.12
let
    v1 = [1, 2, 3, 4, 5]
    v2 = [2, 3, 4, 5, 6]
    v3 = [3, 4, 5, 6, 7]
...
# ╔═╡ bac92b0b-e354-4bbd-8d98-52d9837a1e26
# Code block 3.13/3.14
let
    v = [7, 4, -5, 8, 3]
    o = ones(length(v))
    ave = (v ⋅ o) / length(v)
...
# ╔═╡ 22c0b3de-40cd-46b7-9491-6c5549ddf5e8
# Code block 3.15/3.16
let
    v = [7, 4, −5, 8, 3]
	w = rand(length(v))
	wave = v ⋅ (w / sum(w))
...
manifest_format = "2.0"
project_hash = "8e1c09d5ba00882fb7e5af12b3089aaa13c12065"
